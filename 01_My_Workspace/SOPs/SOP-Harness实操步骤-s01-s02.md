---
created: 2026-07-08
tags: [sop, harness, agent-loop, tool-use, learn-claude-code, Python]
---

# 🛠️ SOP：Harness 实操步骤 - s01 Agent Loop + s02 Tool Use

> **目标**：从零开始跑通 learn-claude-code 教程的前两章
> **适用环境**：macOS + Python 3.9 + Xiaomi MiMo API
> **预计时间**：60-90 分钟
...
- [Harness Engineering 专题笔记](../00_Reference_Library/AI_Web3_School/Harness-Engineering专题.md)

---

> 📝 **最后更新**：2026-07-08
> 🏷️ **适用环境**：macOS + Python 3.9 + Xiaomi MiMo API
